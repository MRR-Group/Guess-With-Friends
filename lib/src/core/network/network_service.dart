  ...
  Never _handleDioError(DioException e) {
    switch (e.type) {
      ...
      case DioExceptionType.receiveTimeout:
        throw MessageException('Connection timeout. Please try again.');
      ...
      case DioExceptionType.cancel:
        throw MessageException('Request was cancelled');

      case DioExceptionType.badCertificate:
        throw MessageException('Bad SSL certificate');

      case DioExceptionType.unknown:
        throw MessageException('Unexpected network error');
    }
  }
}